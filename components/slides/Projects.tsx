                            ...
                            >
                                ...
                                <div className="relative w-full aspect-[16/9] bg-gradient-to-br from-[var(--color-orange-50)] via-white to-[var(--color-orange-100)]/60 overflow-hidden">
                                  {cover.type === "video" ? (
                                    ...
                                    <div className="absolute inset-0 bg-white">
                                      {/* Embed the real PDF (first page) instead of a rendered
                                          picture. Pointer events stay off so a click still opens
                                          the lightbox. */}
                                      <iframe
                              ...
                              <div className={`flex items-start gap-4 p-4 ${hasMedia ? "" : "md:p-5"}`}>
                                <div className="flex-1 min-w-0">
                                  ...
                                  {d && (
                                    <p className="mt-1.5 text-[13px] leading-relaxed text-[var(--color-ink-soft)] line-clamp-3">
                                      {d}
                                    </p>
                                  )}
                                </div>
